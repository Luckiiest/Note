...
![](./PackageManager/pnpm7.png)

4. 从缓存的对应包中使用硬链接放置文件到相应包代码目录中

![](./PackageManager/pnpm8.png)

5. 使用符号链接，将每个包的**直接依赖**放置到自己的目录中

![](./PackageManager/pnpm9.png)
