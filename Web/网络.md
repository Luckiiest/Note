...
![url request.png (1208×446) (raw.githubusercontent.com)](url request-163619392933719.png)
...
![url request.png (1208×446) (raw.githubusercontent.com)](url request.png)
...
- 三次握手
  ...
  ![threeShakes.png (432×418) (raw.githubusercontent.com)](threeShakes.png)
...
![fourShakes.png (401×507) (raw.githubusercontent.com)](fourShakes.png)
...
* ![request-message.jpg (875×513) (raw.githubusercontent.com)](request-message.jpg)
...
* **响应主体**
  - `sign success` (注册成功)
* ![response-message.jpg (1099×650) (raw.githubusercontent.com)](response-message.jpg)
...
- **Date**：服务器相应内容的日期
- ![Date.png (1148×606) (raw.githubusercontent.com)](Date.png)
- **Cache-Control**：内容缓存时间

  ![CacheControl.png (645×345) (raw.githubusercontent.com)](CacheControl.png)
...
#### 服务器代理中转
  ...
  - ![](https://raw.githubusercontent.com/haodex/Note/master/Web/network/jsonp1.png))
  - 当浏览器发送了一个`ajax`请求，这个`ajax`请求指向的是别人服务器的一个文件`xxx.php`，那么可以请求成功吗？不能。浏览器可以请求成功的前提是域名、端口和协议都相同，但别人的服务器和我的同源策略都不相同，所以无法请求文件。
  - ![](https://raw.githubusercontent.com/haodex/Note/master/Web/network/jsonp2.png)
...
- **Cookie**内存大小受限制
  ...
  - ![](https://raw.githubusercontent.com/haodex/Note/master/Web/network/CookieSize.png)
#### Cookie的特点
  ...
  - 解决方法：
    ...
    - ![](https://raw.githubusercontent.com/haodex/Note/master/Web/network/cookieDomain.png)
